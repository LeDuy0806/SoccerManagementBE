...
export class SponsorController {
    ...
    public getSponsors = async (
        ...
        try {
            ...
            res.status(HTTP_STATUS.OK).json(sponsors);
        } catch (error) {
            next(error);
        }
    };

    public getSponsor = async (
        req: Request,
        res: Response,
        next: NextFunction,
    ) => {
        ...
        try {
            ...
            res.status(HTTP_STATUS.OK).json(sponsor);
        } catch (error) {
            next(error);
        }
    };
