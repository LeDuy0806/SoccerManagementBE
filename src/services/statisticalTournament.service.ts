...
@Service()
export class StatisticalTournamentService {
    public async getStatisticalTournaments(): Promise<
        IStatisticalTournament[]
    > {
        try {
            ...
            if (!statisticalTournaments) {
                throw new HttpException(
                    ...
                    `statisticalTournaments not found`,
                );
            }
    ...
    public async getStatisticalTournament(
        id: string,
    ...
    public async createStatisticalTournament(
    ...
    public async updateStatisticalTournament(
        ...
        if (!ObjectId.isValid(id)) {
            throw new HttpException(
                HTTP_STATUS.NOT_FOUND,
                `No statisticalTournament with id: ${id}`,
            );
        }
        ...
        try {
            const updateTournament =
                await StatisticalTournament.findByIdAndUpdate(
                    id,
                    newTournament,
                    {
                        new: true,
